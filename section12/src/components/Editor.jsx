    ...
    return (
        <div className="Editor">
            <section className="date_section">
                <h4>오늘의 날짜</h4>
                <input name="createdDate" onChange={onChangeInput} value={getStringDate(input.createdDate)} type="date"></input>
            </section>
            <section className="emotion_section">
                ...
                <div className="emotion_list_wrapper">
                    ...
                    isSelected={item.emotionId === input.emotionId}></EmotionItem>)}
                </div>
            </section>
            ...
            <section className="button_section">
                ...
                <Button onClick={onClickSubmitButton} text={"작성완료"}></Button>
            </section>
        </div>
    );
}
